...
def build_app(settings: Settings) -> Application:
    ...
    app.add_handler(CallbackQueryHandler(menu_action, pattern=r"^menu:(home|stats|activity|fun|fun_hipish|mod|settings|settings_muteme15|settings_bday|settings_editform|settings_kick_confirm|settings_kick_do):[0-9]+$"))
